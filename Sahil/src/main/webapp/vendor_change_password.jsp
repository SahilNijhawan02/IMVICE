<html>
    <head>
        ...
        <title>Vendor Change Password</title>
        <%@include file="Header.jsp"%>


<!--<style>
body {
  background-image: url('..//myuploads/pass.jpg');
}
</style>-->
        <script>
          ...
          function vendor_change_password()
          {
             ...
             // alert("vendor_change_password_working");
              ...
              var oldpassword= document.getElementById("oldpassword").value ;
               ...
               var xhttp = new XMLHttpRequest();
                ...
                xhttp.open("GET", "./vendor_change_password?email="+em+"&oldpassword="+oldpassword+"&newpassword="+newpassword, true);
...
<!--                                 <div class="form-group">
                            ...
                            <input class="btn btn-primary" type="button" value="Edit Profile" onclick="vendor_change_password()" style="width: 50%">
                            </div>
                            </div>
                        </form>
                    </div>
