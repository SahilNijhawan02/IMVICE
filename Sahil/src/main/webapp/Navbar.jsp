...
<!--                            <li class="nav-item">
                            ...
                            <li class="nav-item">-->
                                <a class="nav-link scroll" href="#pbar">Ratings</a>
                            </li>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="USER_SIGN_UP.jsp">User SignUp</a>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="vendor_sign_up.jsp">Vendor SignUp</a>
    <a class="dropdown-item" href="vendor_login.jsp">Vendor Login</a>
    ...
    <a class="dropdown-item" href="admin_login.jsp">Admin Login</a>
        ...
        <div class="logo text-center">
            <a class="navbar-brand" href="index.jsp">
                <i class="fas fa-home">&nbsp;IMVICE</i><span>your one stop solution</span></a> 
