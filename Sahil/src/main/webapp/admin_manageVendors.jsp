                ...
                xhttp.onreadystatechange = function () {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        for (var i = 0; i < arr.length; i++)
                        {
                            ...
                            ans = ans + "<label class=\"card-text\" style=\"font-size: 15px\" >Name : <br>" + st.Vendor_Name + "</label><br><br>";
                            ans = ans + "</div>";
                            ans = ans + "</div>";
...
<%@include file="Header.jsp"%>
    ...
    <body onload="showvendors()" style="background-color: #062c33" >
        ...
        <div class="container text-center text-success" >
            <div style="border: 2px solid black; border-radius: 10px;margin-top: 50px;margin-bottom: 50px ;background-color: white; padding: 10px"  >
